...
export default function OurMission() {
  return (
    <section className="ourMission">
      ...
      <p>
        Whether you're starting a family or expanding a business, you need a
        bank that understands you. That's what Prosperity Trust Bank does. No
        matter the size of your books, we're here to help you{" "}
        <span className="accent bold">write your story</span>.
      </p>
      <div>
        <BankingService
